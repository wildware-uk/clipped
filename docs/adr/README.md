...
| [0008](0008-codec-patent-position.md) | AV1 is the codec Clipped commits to where the hardware offers it, and on most machines today that means HEVC | Accepted |
