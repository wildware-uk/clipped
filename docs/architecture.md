...
[waveforms.md](waveforms.md) and [editing.md](editing.md)
...
engine and no edit operation is written, and the document says so.
`waveforms.md` covers the peak generator, which is written, and is explicit that
