...
export interface Screen {
    ...
    /**
     * One sentence describing what the screen is for, shown while it is
     * unbuilt so that the navigation is readable rather than a list of nouns.
     */
     ...
     * (AGENTS.md sections 27 and 54). Clearing this field is part of the work
     * of the issue it names.
     */
...
export const SCREENS: readonly Screen[] = [
    {
        ...
        label: 'Home',
        group: 'primary',
        summary: 'What the recorder is doing now, and the sessions and clips it produced most recently.',
        trackedBy: 60,
    },
    {
        id: 'library',
    ...
    },
    {
        ...
        label: 'Settings',
        group: 'primary',
        summary: 'Recording, audio, storage, hotkeys and interface settings.',
        trackedBy: 51,
    },
    {
        id: 'trash',
 ...
 * restored window state, a deep link from the tray - and must be rejected
 * rather than trusted.
 */
