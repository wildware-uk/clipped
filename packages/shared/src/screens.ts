 ...
 *
 * Three of these screens have been written — Games, Settings and Diagnostics, in
 * `GamesScreen.tsx`, `SettingsScreen.tsx` and `DiagnosticsScreen.tsx`. The shell
 * routes the other four to a panel that says the screen is not written and names
