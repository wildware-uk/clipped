 ...
 * screen so that the content region always has an accessible name, and so that
 * the heading level is decided once instead of per screen.
 */
    ...
    return (
        <div className="app-shell">
            ...
            <div className="app-body">
                ...
                {/* `tabIndex={-1}` is what lets the skip link land here: without
                    it the anchor scrolls the region into view but leaves focus
                    where it was, and the next Tab goes back to the sidebar. */}
                <main
                    id={MAIN_ID}
                    className="app-main"
                    tabIndex={-1}
