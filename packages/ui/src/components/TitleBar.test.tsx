...
describe('TitleBar', () => {
  ...
  it('drives the window from the keyboard', async () => {
    ...
    render(<TitleBar name="Clipped" tagline="Game Recorder" windowControls={windowControls} />);
  ...
  it('keeps the drag region clear of the buttons, so a click is never swallowed', () => {
