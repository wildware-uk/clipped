...
export interface SidebarProps {
    ...
    /**
     * The block at the foot of the sidebar. The design puts recorder status
     * and its two actions there; until the recorder is reachable (issue #49)
     * the application passes what it can honestly say.
     */
    footer?: ReactNode;
}
 ...
 * inside a list, so a screen reader announces "list, 5 items" and the keyboard
 * reaches every one with Tab alone - no roving tabindex, no key handler of our
 * own, nothing to get wrong.
 */
                ...
                return (
                    <li key={screen.id}>
                        <button
                            ...
                            // `page` rather than `true`: this is the document
                            // the user is on, which is what a screen reader
