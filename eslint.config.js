...
export default tseslint.config(
  {
    // Build output and dependencies. `src-tauri/target` is Cargo's and `dist`
    // is Vite's; neither is source anybody wrote.
    ignores: ['**/dist/**', '**/node_modules/**', 'apps/desktop/src-tauri/target/**', 'target/**'],
  },
  ...
  {
    // This file is not part of any package's tsconfig, so the type-aware rules
    // have nothing to read and would fail rather than lint.
